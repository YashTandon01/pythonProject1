...
def volume_fourty():
    volume.SetMasterVolumeLevel(-14.0, None)

def volume_fifty():
    volume.SetMasterVolumeLevel(-10.0, None)

def volume_sixty():
    volume.SetMasterVolumeLevel(-7.0, None)
...
while True:
    # if 1:
        ...
        elif 'set volume 0' in query:
            volume_zero()

        elif 'set volume 10' in query:
            volume_ten()

        elif 'set volume 20' in query:
            volume_twenty()

        elif 'set volume 30' in query:
            volume_thirty()

        elif 'set volume 40' in query:
            volume_fourty()

        elif 'set volume 50' in query:
            volume_fifty()

        elif 'set volume 60' in query:
            volume_sixty()

        elif 'set volume 70' in query:
            volume_seventy()

        elif 'set volume 80' in query:
            volume_eighty()

        elif 'set volume 90' in query:
            volume_ninty()
